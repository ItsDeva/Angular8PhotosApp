...
var AppComponent = /** @class */ (function () {
    function AppComponent(quoteService) {
    ...
    AppComponent.prototype.nextBatch = function () {
        var _this = this;
        this.loader = true;
        this.hits = [];
        this.quoteService.getNewQuotes().subscribe(function (data) {
            console.log('hits', data);
            _this.hits = data['hits'];
            _this.loader = false;
...
var QuoteService = /** @class */ (function () {
    ...
    QuoteService.prototype.getNewQuotes = function () {
